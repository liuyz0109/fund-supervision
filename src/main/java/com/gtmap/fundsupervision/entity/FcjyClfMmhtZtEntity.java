 ...
 */
@Entity
@Table(name = "FCJY_CLF_MMHT_ZT", schema = "SCOTT", catalog = "")
public class FcjyClfMmhtZtEntity implements Serializable {
    private String ztid;
    private Long ztbh;
    private Long htbh;
    private String ztlb;
    ...
    public boolean equals(Object o) {
        ...
        FcjyClfMmhtZtEntity that = (FcjyClfMmhtZtEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ztid, ztbh, htbh, ztlb, ztxm, xb, csrq, zjlb, zjhm, fzjg, dz, lxdh, yb, dzyj, gjdq, hjszs1, hjszs2, jzszs1, jzszs2, yh, hm, zh, dlrxm, dlrzjlb, dlrzjhm, dlrdz, dlrlxdh, bz);
    }
}
