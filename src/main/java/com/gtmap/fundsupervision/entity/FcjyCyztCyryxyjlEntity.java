 ...
 */
@Entity
@Table(name = "FCJY_CYZT_CYRYXYJL", schema = "SCOTT", catalog = "")
public class FcjyCyztCyryxyjlEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        FcjyCyztCyryxyjlEntity that = (FcjyCyztCyryxyjlEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xyjlid, xyjlbh, xyjllx, xyjlfz, ryid, jlry, jlsj, bz);
    }
}
